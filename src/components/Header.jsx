...
const Header = () => {
  ...
  return (
    ...
    >
      ...
      {/* Mobile Menu */}
      {menuOpen && (
        <div className="md:hidden fixed top-0 left-0 w-full h-200 bg-grey-800 bg-opacity-40 backdrop-blur-sm z-40">
          <button
            onClick={closeMenu}
          ...
          <div className="flex flex-col items-center justify-center text-white">
            <a
              href="#home"
              onClick={closeMenu}
              className="text-4xl font-extrabold text-yellow-500 mb-8"
            ></a>
            <nav>
